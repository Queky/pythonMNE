...
raw = mne.io.read_raw_edf("ma0844az_1-1+.edf", stim_channel=None, preload=True) # Se lee el archivo bdf mediante mne
...
events = mne.find_events(raw, stim_channel='EEG C3')
print(events[:5])